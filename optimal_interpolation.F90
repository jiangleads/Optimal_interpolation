!! 程序手册网站 http://modb.oce.ulg.ac.be/mediawiki/index.php/Optimal_interpolation_Fortran_module_with_Octave_interface
...
!$omp end parallel 
      ...
      subroutine optiminterp_gw(n,gn,on,nparam,ox,of,ovar,param,m,gx,gf,gvar) bind(c)
      USE ISO_C_BINDING
      implicit none
